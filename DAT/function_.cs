...
namespace POSSystem02.DAT
{
    public class function_
    {
        ...
        string i = Config.ConnectionString;// @"server=127.0.0.1;user id=root;database=hardwear;default command timeout=1000";//arifpos
        ...
        {
            but.BackColor = Color.FromArgb(224, 224, 224);

        }

        public void lostFocusOnButtonBySave(Button but)
        {
        ...
        public void AddMessage() { MessageBox.Show("Data successfully saved !!!", Config.ApplicationName, MessageBoxButtons.OK, MessageBoxIcon.Information); }
        public void EditMessge() { MessageBox.Show("Data successfully Updated !!!", Config.ApplicationName, MessageBoxButtons.OK, MessageBoxIcon.Information); }
        public void DeleteMessge() { MessageBox.Show("Data successfully deleted !!!", Config.ApplicationName, MessageBoxButtons.OK, MessageBoxIcon.Information); }
        public void validationMessge(string validate) { MessageBox.Show(validate, Config.ApplicationName, MessageBoxButtons.OK, MessageBoxIcon.Information); }
        public void ErrorMessge(string validate) { MessageBox.Show(validate, Config.ApplicationName, MessageBoxButtons.OK, MessageBoxIcon.Error); }
        public void WwarningMessge(string validate) { MessageBox.Show(validate, Config.ApplicationName, MessageBoxButtons.YesNo, MessageBoxIcon.Warning); }
        ...
        public void getData(AutoCompleteStringCollection dataCollection, string sql)
        {
            try
            {
                ...
                // DAT.DataAccessLayer connection = new DAT.DataAccessLayer();
